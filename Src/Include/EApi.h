...
#define EAPI_CURRENT_SEMA_VERSION	"ADLINK-SEMA-EC/BMC-WINDOWS-V4_R2_15_25_09_03"
/*
**G P I O*
*/
/* IDs */
...
#define EAPI_SEMA_ID_HWMON_SYSTEM_TEMP              EAPI_UINT32_C(0x10021)
#define EAPI_SEMA_ID_HWMON_SYSTEM_MIN_TEMP			EAPI_UINT32_C(0x10022)
#define EAPI_SEMA_ID_HWMON_SYSTEM_MAX_TEMP			EAPI_UINT32_C(0x10023)
#define EAPI_SEMA_ID_HWMON_SYSTEM_STARTUP_TEMP		EAPI_UINT32_C(0x10024)

#define EAPI_ID_HWMON_CPU_TEMP					EAPI_UINT32_C(0x20000) 
/*0.1 Kelvins */
#define EAPI_ID_HWMON_CHIPSET_TEMP				EAPI_UINT32_C(0x20001) 
/*0.1 Kelvins */
#define EAPI_ID_HWMON_BOARD_TEMP				EAPI_UINT32_C(0x20002)
/*0.1 Kelvins */
