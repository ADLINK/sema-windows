...
EERROR CSMBusFunct::StorageCap(uint8_t Region, uint32_t *nSize, uint32_t* nBlk)
{
...
EERROR CSMBusFunct::ReadMemL(uint8_t Region, uint32_t nAdr, uint8_t* pData, uint32_t nSize)
{
	uint32_t nRet = nSize;
...
EERROR CSMBusFunct::WriteMemL(uint8_t Region, uint32_t nAdr, uint8_t* pData, uint32_t nSize)
{
	uint32_t nRet = nSize;
...
EERROR CSMBusFunct::WriteMem(uint8_t Region, uint32_t nAdr, uint8_t* pData, uint32_t nSize)
{
	EERROR Status;
...
EERROR CSMBusFunct::ReadMem(uint8_t Region, uint32_t nAdr, uint8_t* pData, uint32_t nSize)
{
	EERROR Status;
	int end = nAdr + nSize, start = nAdr, nSizeL;
...
EERROR CSMBusFunct::ClearMem(uint8_t Region)
{
...
EERROR CSMBusFunct::UnlockMem(uint8_t Region, uint8_t Permission, char* passcode)
{
	uint8_t pData_[10] = { 0 };
	uint32_t nDataRet;
...
EERROR CSMBusFunct::LockMem(uint8_t Region)
{
	uint8_t pData_[10] = { 0 };
	uint32_t nDataRet;
